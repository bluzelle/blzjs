...
export const verify = (msg_bin: Buffer, sig_bin: Buffer, pub_key_base64: string) => {
...
export const sign = (msg_bin: Buffer, priv_key_base64: string) => {
...
export const pub_from_priv = (priv_key_base64: string) => {
...
export const import_public_key_from_base64 = (pub_key_base64: string) => {
    ...
    assert(header === "3056301006072a8648ce3d020106052b8104000a034200",
...
export const import_private_key_from_base64 = (priv_key_base64: string) => {
    ...
    assert(header2 === "a00706052b8104000aa1440342",
        "ECDSA Private Key Import: private key header is malformed. This is the private key you're trying to decode: \"" + priv_key_base64 + '"');
...
export const get_pem_private_key = (ec: any): string => Buffer.from(
