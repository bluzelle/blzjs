...
Registry_1.addRegistryType("/bluzelle.curium.crud.MsgCreate", tx_1.MsgCreate);
Registry_1.addRegistryType('/bluzelle.curium.crud.MsgUpsert', tx_1.MsgUpsert);
Registry_1.addRegistryType("/bluzelle.curium.crud.MsgDelete", tx_1.MsgDelete);
class API {
    constructor(config) {
        this.address = '';
        this.chainId = '';
