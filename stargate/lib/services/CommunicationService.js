...
const tx_2 = require("@cosmjs/proto-signing/build/codec/cosmos/tx/v1beta1/tx");
...
const transmitTransaction = (service, messages, { memo }) => {
    ...
    return exports.getClient(service.api)
        ...
        .then((txRaw) => Uint8Array.from(tx_2.TxRaw.encode(txRaw).finish()))
...
const myRegistry = new proto_signing_1.Registry([
    ...stargate_1.defaultRegistryTypes,
    ["/bluzelle.curium.crud.MsgCreateCrudValue", tx_1.MsgCreateCrudValue],
    ['/bluzelle.curium.crud.MsgUpsertCrudValue', tx_1.MsgUpsertCrudValue],
    ["/bluzelle.curium.crud.MsgDeleteCrudValue", tx_1.MsgDeleteCrudValue]
]);
// Inside an async function...
const getSigner = (mnemonic) => proto_signing_1.DirectSecp256k1HdWallet.fromMnemonic(mnemonic, undefined, "bluzelle");
exports.getClient = lodash_1.memoize((api) => getSigner(api.mnemonic)
    .then(signer => stargate_1.SigningStargateClient.connectWithSigner(api.url, signer, {
    registry: myRegistry,
})));
