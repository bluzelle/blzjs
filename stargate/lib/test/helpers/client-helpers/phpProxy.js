...
const phpProxy = async (bz, bluzelleConfig) => {
    const env = {
        MNEMONIC: bluzelleConfig.mnemonic,
        ENDPOINT: bluzelleConfig.endpoint,
        UUID: bluzelleConfig.uuid
    };
    await DockerManager_1.deleteProxyContainer('php');
    await DockerManager_1.startProxyContainer('php', env);
...
exports.phpProxy = phpProxy;
//# sourceMappingURL=phpProxy.js.map