...
const goProxy = async (bz, bluzelleConfig) => {
    ...
    await DockerManager_1.deleteProxyContainer('go');
    await DockerManager_1.startProxyContainer('go', env);
...
//# sourceMappingURL=goProxy.js.map